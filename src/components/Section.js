...
<SubTitle>saving you hours everyday to focus on what matters to you</SubTitle>
<ButtonGroup><Button>Free Consultation</Button></ButtonGroup>
<FadeDiv>
        <Fade left >
...
padding-left:100px;
color:#E55F03`
const ButtonGroup=styled.div`padding-left:10px;
padding-top:10px;
